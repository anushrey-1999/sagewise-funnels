  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-10 space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-primary-main">Adwalls</h1>
          <p className="text-sm text-general-muted-foreground mt-1">
            Keys are <code>routePrefix/type</code> (e.g. <code>mortgage/one</code>, <code>cc/two</code>).
          </p>
        </div>
      ...
      <CreateConfigNav basePath="/admin/adwalls" placeholder='e.g. "mortgage/one" or "cc/finbuzz"' />
      ...
      <div className="bg-white border border-general-border rounded-lg overflow-hidden">
        ...
        {rows.length ? (
          ...
          <div className="px-4 py-6 text-sm text-general-muted-foreground">No adwalls yet.</div>
        )}
      </div>
    </div>
  );
