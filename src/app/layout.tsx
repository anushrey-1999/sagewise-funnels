...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${fontSans.variable} ${fontMono.variable}`}>
      <head>
        {/* Restore interstitial → adwall handoff class before first paint. */}
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{if(sessionStorage.getItem("sw-handoff")==="1"){sessionStorage.removeItem("sw-handoff");document.documentElement.setAttribute("data-sw-handoff","in");}}catch(e){}})();`,
          }}
        />
