  ...
  return (
    ...
    >
      <span
        ref={triggerRef}
        className={cn(
          "text-neutral-black hover:text-neutral-muted cursor-pointer",
          triggerClassName
        )}
        role="button"
        tabIndex={0}
