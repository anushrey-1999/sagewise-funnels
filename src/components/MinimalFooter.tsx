...
const MinimalFooter = () => {
  return (
    <footer className="w-full bg-white border-t border-general-border">
      <div className="max-w-[var(--container-max)] mx-auto px-4 sm:px-0 py-4">
        <div id="minimal-footer-slot" className="w-full empty:hidden mb-4" />

        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center justify-center sm:justify-start flex-wrap gap-x-4 gap-y-2">
            <Logo
            ...
            <nav className="flex flex-wrap items-center justify-center sm:justify-start gap-x-3 gap-y-2 text-[10px] text-aw-muted">
