  ...
  return (
    <input
      ...
      className={cn(
        ...
        "aria-invalid:border-destructive aria-invalid:hover:border-destructive aria-invalid:hover:shadow-[var(--focus-ring-error)] aria-invalid:focus-visible:shadow-[var(--focus-ring-error)]",
